const star_rating = () => {
  return (
    <div class="grid w-full overflow-x-scroll rounded-lg lg:overflow-visible pl-3">
        ...
        <div class="inline-flex items-center">
          <span>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              class="w-3 h-3 text-yellow-700 cursor-pointer"
            >
              <path
                fill-rule="evenodd"
          ...
          <span>
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="w-3 h-3 cursor-pointer text-blue-gray-500"
            >
              <path
